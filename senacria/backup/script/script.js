...
const botMessages = {
    "1": "agência de desenvolvimento de sites Senacria, constrói, otimiza e mantém sites responsivos e atrativos. Oferece design gráfico, SEO, e-commerce, suporte técnico, marketing digital e consultoria, garantindo uma presença online eficaz para alcançar o público-alvo e impulsionar negócios.<br><br>Digite Voltar para retornar ao menu inicial.",
    "2": "Na nossa agência de desenvolvimento de sites Senacria, valoriza a entrega pontual dos serviços. Com prazos bem definidos e comunicação transparente, garanto que cada projeto seja concluído dentro do cronograma acordado, atendendo suas expectativas e necessidades sem comprometer a qualidade.<br><br>Digite Voltar para retornar ao menu inicial.",
    "3": "Na nossa agência de desenvolvimento de sites Senacria, ofereço diversas formas de pagamento para sua conveniência. Aceito transferências bancárias, cartões de crédito e débito, além de pagamentos via plataformas digitais. Trabalho com planos de pagamento flexíveis, permitindo parcelamentos que se ajustam ao seu orçamento, sempre com total transparência e segurança.<br><br>Digite Voltar para retornar ao menu inicial.",
    "ajuda": "Olá, você está falando com nosso Boot de atendimento da Senacria. Estou aqui para te ajudar a tirar suas dúvidas. Digite:<br><br>1 para dúvidas sobre nossos serviços<br><br>2 para dúvidas sobre nossa entrega de projeto<br><br>3 para dúvidas sobre formas de pagamento.<br><br>",
    "voltar": "Olá, você está falando com nosso Boot de atendimento da Sapataria Tico. Estou aqui para te ajudar a tirar suas dúvidas. Digite:<br><br>1 para dúvidas sobre nossos serviços<br><br>2 para dúvidas sobre nossa entrega de projeto<br><br>3 para dúvidas sobre formas de pagamento.<br><br>",
...
addMessage('Atendimento', 'Olá, você está falando com nosso Boot de atendimento do SenaCria :). Estou aqui para te ajudar a tirar suas dúvidas. Digite "oi" para começar.');
